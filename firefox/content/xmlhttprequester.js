function tinted_sheen_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
tinted_sheen_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				tinted_sheen_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
tinted_sheen_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
tinted_sheen_xmlhttpRequester.prototype.setupRequestEvent =
